import { Ionicons } from "@expo/vector-icons";
    ...
    const { isPremium, isLoading: rcLoading, setShowPaywall, setFreeMareCount } = useSubscription();
    ...
    // Keep context in sync so PaywallModal knows how many free slots remain
    useEffect(() => {
      setFreeMareCount(mareCount);
    }, [mareCount, setFreeMareCount]);
    ...
    return (
      <View style={[styles.container, { backgroundColor: colors.background }]}>
        ...
        <View style={[styles.header, { borderBottomColor: colors.border, paddingHorizontal: horizontalPad }]}>
          ...
          {/* Only show the upgrade banner when the free limit has been reached */}
          {atFreeLimit && (
            <TouchableOpacity
            ...
            >
              ...
              <Text style={styles.upgradeText}>
                Free preview limit reached — Upgrade for unlimited mares
              </Text>
